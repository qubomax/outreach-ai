...
import { Users, Mail, Send, TrendingUp, ArrowRight, Clock, AlertCircle } from "lucide-react";
    ...
    <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm text-amber-800">
              Connect your Gmail inbox in Settings to start sending sequences.
            </p>
          </div>
          <Link href="/settings">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <Card className="bg-white border-slate-200 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-xs font-medium text-slate-500 flex items-center gap-2">
              <Send className="w-3.5 h-3.5" /> Emails Sent
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-3xl font-bold text-slate-900">{sentCount}</p>
          </CardContent>
        </Card>
